...
public class Main {
    ...
    //method 정의 영역
    /*
        현재 AnimalData에서는 field로 들어온 객체가 Animal 클래스의 서브 클래스인지 아닌지 구분할 수 없기 때문에, 이를 판단하는 메서드를 Main에서 정의한다.
     */
    ...
    public static void main(String[] args) {
        ...
        /*
            이상의 상황에서는 AnimalData에 Car 객체가 animal field에 들어가 있지만, 문제가 되지는 않습니다.
            그러면 animal field에 Tiger/Human/Car 객체가 들어가 있다는 점은 여기 main에서 확인이 안 된다.
            코드 다른곳을 보아야 한다.
         */
...
//        animalData3.showData();
        /*
            animalData3.showData();에서 오류 발생을 확인할 수 있다.
         */
