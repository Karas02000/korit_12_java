...
public class JSON1 {
    public static void main(String[] args) {
        ...
        /*
            ...
            1. Map에서는 Key에 ""가 없었고, JSON에서는 모든 Key에 String 자료형처럼 보이도록 ""가 있습니다.
            2. Map에서는 콘솔창에서 출력될 때 key1 = value1으로 "="로 표기되었지만, JSON에서는 "key1":value1의 형태로 작성되었습니다.
         */
        ...
        /*
            컴퓨터에서 콘솔로 출력한 결과를 확인했을때, JSON 결과값이 한 줄로 길게 늘어져있다.
            나무위키에서는 막 엔터를 넣는 등을 사용하여 가독성을 개선하기도 하지만,
            컴퓨터가 아니라 사람이 읽기 적합한 형태로 출력하는 것을 pretty pringting이라고 표현합니다.
         */
